...
Ознака испита: <input type="text" name="filter" />
...
if ($IspitnaPrijavaViewObject->BrojZapisa==0)
	...
	echo "УКУПАН БРОЈ ЗАПИСА:".$IspitnaPrijavaViewObject->BrojZapisa;
		...
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"IspitnaPrijavaIzmeniForm.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"OznakaIspita\" value=\"$OznakaIspita\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniIspitnuPrijavu\" value=\"ИЗМЕНИ\" /></font></b>";
		echo "</form>";
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"IspitnaPrijavaObrisi.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"OznakaIspita\" value=\"$OznakaIspita\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"obrisiIspitnuPrijavu\" value=\"ОБРИШИ\"  onclick=\"return confirm('Da li ste sigurni da zelite da obrisete zapis?')\"/></font></b>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
