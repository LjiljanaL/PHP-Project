...
if ($IspitnaPrijavaViewObject->BrojZapisa==0)
	...
	echo "УКУПАН БРОЈ ЗАПИСА:".$IspitnaPrijavaViewObject->BrojZapisa;
		...
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$StudentPrezime</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$StudentIme</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$Predmet</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$IspitniRok</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$Termin</font><br/>";
		echo "</td>";
		echo "</tr>";
