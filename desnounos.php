...
<td align="center">
<b><font face="Trebuchet MS" color="black" size="3px">УНОС НОВЕ ИСПИТНЕ ПРИЈАВЕ</b></br>
</td>
<td style="width:3%;">
</td>
</tr>
...
<!------------------------FORMA ZA UNOS ---- ACTION="ispitnaprijavasnimi.php" --->
<table style="width:50%;" bgcolor="#D8E7F4" padding:0" align="center" cellspacing="0" cellpadding="0" border="0">
<form name="FormaZaUnosIspitnePrijave" action="ispitnaprijavasnimi.php" METHOD="POST" enctype="multipart/form-data" >
