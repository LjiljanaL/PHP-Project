...
// koristimo klasu za poziv procedure za konekciju
    ...
    {	
		...
		$IspitnaPrijavaViewObject = new DBIspitnaPrijava($KonekcijaObject,"ispitna prijava");
		if (isset($_GET['filtriraj']))
			{
				// prikaz filtriranih podataka primenom pogleda nad kojim je dodat filter
				$filter=$_GET['filter'];
				$IspitnaPrijavaViewObject->DajSvePodatkeOIspitima($filter);
...
<?php include 'delovi/desnoIspitnaPrijavaLista.php';?>
</td>
